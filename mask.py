...
def get_color_for_attention_score(attention_score):
    ...
    """
    gray_score = round(float(attention_score)*255)

    shade_of_gray = (gray_score,gray_score,gray_score)
...
def visualize_attentions(tokens, attentions):
    ...
    for i, layer_attentions in enumerate(attentions):
        # Iterate over attention heads in the layer
        for j, head_attention in enumerate(layer_attentions[0]):
            # Call generate_diagram for each layer and head
